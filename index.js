...
const descriptionText = `A total of $${GAMES_JSON.reduce((total, game) => total + game.pledged, 0).toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numberOfUnfundedGames} game${numberOfUnfundedGames !== 1 ? 's ' : ' is'} remain unfunded. We need your help to fund these amazing games!`;
